...
> Fresh Design deployed on github Pages meeting the above criteria


*Tier Two*

> Fresh Design deployed on Heroku with Express routes serving up static HTML Pages

*Tier Three*

> Fresh Design deployed on Heroku with Express routes serving up HTML Pages with client side JS that request JSON from an API route from your Database query. 

Server side Sequalize Models
