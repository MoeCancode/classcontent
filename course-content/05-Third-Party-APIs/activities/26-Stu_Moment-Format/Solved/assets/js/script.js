...
// var today = moment();
// var today = moment("2021-12-07");
// today.format("MMM Do, YYYY")

var gradDate = moment("6/13/2022").format("MMM Do, YYYY");
$("#1a").text(gradDate);
// bonus: 
$("#1a").append("<br/>Days Remaining: " + moment("6/13/2022", 'MM/DD/YYYY').diff(moment(), 'days'))

// TODO: 2. What day of the week was 1/1/2022?
